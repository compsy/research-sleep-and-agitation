...
data_file <- file.path('data','MWLS03 (dagelijks_geknipt_noexo).sav')
imputed_data_file_name <- file.path('output', 'nonimputed_003_geknipt_noexo.csv')
autovar_output_file_name <- file.path('output','sink_SA_003_geknipt_noexo.txt')
irf_output_file_name <- file.path('output', 'sink_SA_003_geknipt_noexo_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_003_geknipt_noexo_irf.pdf')
