...
data_file <- file.path('data','MWLS03 (dagelijks_geknipt_noexo_50).sav')
imputed_data_file_name <- file.path('output', 'nonimputed_003_geknipt_noexo_50.csv')
autovar_output_file_name <- file.path('output','sink_SA_003_geknipt_noexo_50.txt')
irf_output_file_name <- file.path('output', 'sink_SA_003_geknipt_noexo_50_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_003_geknipt_noexo_50_irf.pdf')
