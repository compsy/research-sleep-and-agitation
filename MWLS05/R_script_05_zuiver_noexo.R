...
data_file <- file.path('data','MWLS05 (dagelijks_zuiver_noexo).sav')
imputed_data_file_name <- file.path('output', 'imputed_005_zuiver_noexo.csv')
autovar_output_file_name <- file.path('output','sink_SA_005_zuiver_noexo.txt')
irf_output_file_name <- file.path('output', 'sink_SA_005_zuiver_noexo_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_005_zuiver_noexo_irf.pdf')
