...
data_file <- file.path('data','MWLS05 (dagelijks_zuiver).sav')
imputed_data_file_name <- file.path('output', 'imputed_005_zuiver.csv')
autovar_output_file_name <- file.path('output','sink_SA_005_zuiver.txt')
irf_output_file_name <- file.path('output', 'sink_SA_005_zuiver_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_005_zuiver_irf.pdf')
