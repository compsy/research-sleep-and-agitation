...
data_file <- file.path('data','MWLS02 (dagelijks laggedexo_geknipt).sav')
imputed_data_file_name <- file.path('output', 'imputed_laggedexo_002_geknipt.csv')
autovar_output_file_name <- file.path('output','sink_SA_laggedexo_002_geknipt.txt')
irf_output_file_name <- file.path('output', 'sink_SA_laggedexo_002_geknipt_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_laggedexo_002_geknipt_irf.pdf')
