...
data_file <- file.path('data','MWLS01 (dagelijks_zuiver_noexo).sav')
imputed_data_file_name <- file.path('output', 'imputed_001_zuiver_noexo.csv')
autovar_output_file_name <- file.path('output','sink_SA_001_zuiver_noexo.txt')
irf_output_file_name <- file.path('output', 'sink_SA_001_zuiver_noexo_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_001_zuiver_noexo_irf.pdf')
