...
data_file <- file.path('data','MWLS01 (dagelijks_geknipt_noexo_40).sav')
imputed_data_file_name <- file.path('output', 'imputed_001_geknipt_noexo_40.csv')
autovar_output_file_name <- file.path('output','sink_SA_001_geknipt_noexo_40.txt')
irf_output_file_name <- file.path('output', 'sink_SA_001_geknipt_noexo_40_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_001_geknipt_noexo_40_irf.pdf')
