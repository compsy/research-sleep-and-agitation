...
data_file <- file.path('data','MWLS01 (dagelijks_zuiver).sav')
imputed_data_file_name <- file.path('output', 'imputed_001_zuiver.csv')
autovar_output_file_name <- file.path('output','sink_SA_001_zuiver.txt')
irf_output_file_name <- file.path('output', 'sink_SA_001_zuiver_irf.txt')
irf_output_pdf_file_name <- file.path('output', 'SA_001_zuiver_irf.pdf')
